...
class FarmApi {
  ...
  static Future<Map<String, dynamic>> _get(String path) async => _handle(await AppHttp.get(Uri.parse("$_base$path"), headers: await _headers()));
  ...
  static Future<Map<String, dynamic>> ledgerAdd(Map<String, dynamic> body) => _post("/ledger", body);
  ...
  static Future<Map<String, dynamic>> reportPrice(String crop, String market, double price) => _post("/prices/report", {"cropType": crop, "market": market, "pricePerKg": price});
